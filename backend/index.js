...
import getAlertsRoute from "./src/routes/alerts/getAlertsRoute.js";
import postAlertRoute from "./src/routes/alerts/postAlertRoute.js";
import putAlertRoute from "./src/routes/alerts/putAlertRoute.js";
...
app.use(
  cors({
    origin: `${serverConfig.protocal}://${serverConfig.host}:${serverConfig.frontendPort}`, // Set the allowed origin for CORS requests
...
// Alerts routes for the application
app.use("/api/", getAlertsRoute);
app.use("/api/", postAlertRoute);
app.use("/api/", putAlertRoute);
